...
Every skill here is a mirror of the upstream package's own `skills/` directory, kept in sync by [`sync.yml`](../.github/workflows/sync.yml). The upstream repo is the place to file an issue or send a fix.

---

## wind-ui

**Skill:** 2.11.0 · **Package:** `fluttersdk_wind` 1.3.0
...
**Skill:** 0.1.4 · **Package:** `magic` 0.0.6
...
**Skill:** 0.0.9 · **Package:** `fluttersdk_dusk` 0.0.9
...
**Skill:** 0.0.4 · **Package:** `fluttersdk_telescope` 0.0.4
...
**Skill:** 0.0.3 · **Package:** `fluttersdk_artisan` 0.0.9
